...
%_installUtilPath%\installUtil /unattended /username=%COMPUTERNAME%\ServiceAdmin /password=%_adminPassword% /webpath="%cd%" SchedulerService.exe > InstallSchedulerService.txt
SET _service_name=KenticoCMSScheduler%_application_service%
